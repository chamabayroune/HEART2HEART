          ...
          <tr>
           ...
           <input name="situation" class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 " type="text" value="{{$patient->situation}}">
            ...
            <form method="POST" action="/deleteepatient/{{$patient->id}}">
                        @csrf
                        @method('DELETE')
                        <button class="text-red-500"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path d="M4 8H20V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V8ZM6 10V20H18V10H6ZM9 12H11V18H9V12ZM13 12H15V18H13V12ZM7 5V3C7 2.44772 7.44772 2 8 2H16C16.5523 2 17 2.44772 17 3V5H22V7H2V5H7ZM9 4V5H15V4H9Z" fill="#000"></path></svg>
                        </button>
</form>
          </td>
          </tr>
    ...
    <div class="rounded-t mb-0 px-4 py-3 border-0">
      <div class="flex flex-wrap items-center">
        ...
        <div class="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
          <button   id="btn-add" class="bg-indigo-500 text-white active:bg-indigo-600 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">add</button>
        </div>
      </div>
    </div>
...
<section class="py-1 ">
  ...
  <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
    <div class="rounded-t mb-0 px-4 py-3 border-0">
      <div class="flex flex-wrap items-center">
        <div class="relative w-full px-4 max-w-full flex-grow flex-1">
          <h3 class="font-semibold text-base text-blueGray-700">Donations</h3>
        </div>
      ...
      <table class="items-center bg-transparent w-full border-collapse ">
        ...
        @foreach($Donateur as $donateur)
          <tr>
            ...
            <form method="POST" action="/updateDonations/{{$donateur->id}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
            <td>
           <input name="situtation" class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 " type="text" value="{{$donateur->situtation}}">
            </td>
            <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 ">
                        <button class="bg-laravel text-black rounded py-2 px-4 hover:bg-black">update</button>
            </td>
            ...
            <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 ">
            <form method="POST" action="/deletedonateur/{{$donateur->id}}">
                        @csrf
                        @method('DELETE')
                        <button class="text-red-500"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path d="M4 8H20V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V8ZM6 10V20H18V10H6ZM9 12H11V18H9V12ZM13 12H15V18H13V12ZM7 5V3C7 2.44772 7.44772 2 8 2H16C16.5523 2 17 2.44772 17 3V5H22V7H2V5H7ZM9 4V5H15V4H9Z" fill="#000"></path></svg>
                        </button>
